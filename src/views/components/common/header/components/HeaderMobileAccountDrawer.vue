...
const drawerActionLinkClass =
  "flex items-center gap-3 text-sm font-semibold hover:bg-[#ffffff10] p-4 rounded-[8px] transition-colors";
</script>
<template>
    <div class="lg:hidden fixed inset-0 z-[100000]">
      ...
      <aside
        class="relative ml-auto h-full max-w-[390px] w-full bg-[#0f4a38] text-white overflow-y-auto shadow-[-22px_0_50px_rgba(0,0,0,0.45)]"
      >
        <div class="p-4 border-b border-[#ffffff1a]">
          <div class="flex items-center justify-between mb-5">
            ...
            <button
              type="button"
              aria-label="Close account menu"
              class="h-10 w-10 inline-flex items-center justify-center rounded-[8px] bg-[#3a6370] hover:brightness-125 text-white cursor-pointer"
              @click="emit('close')"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            class="w-full min-h-[42px] rounded-[8px] bg-[#1777d5] hover:bg-[#2386e7] text-white cursor-pointer text-base font-semibold"
          >
            Log In
          </button>
          ...
          <ul class="mt-5 space-y-1">
            <li>
              <a
                href="#"
                class="flex items-center gap-2 text-sm font-semibold hover:bg-[#ffffff10] p-3 rounded-[8px]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="21"
          ...
          <ul class="space-y-1">
            ...
            <li>
              ...
              >
                ...
                <span>Battle.net Mobile App</span>
              </a>
            </li>
          </ul>
        </div>
